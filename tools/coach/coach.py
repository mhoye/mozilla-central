...
# The idea here is pretty simple: coach.py will look at each file in your patch,
# and for each file it will look at the last N commits that involved that file, 
# adding them to the list of commits to examine. From the complete list, check them
# for related files that aren't in your 
